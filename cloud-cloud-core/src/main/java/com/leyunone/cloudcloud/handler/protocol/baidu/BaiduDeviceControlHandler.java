 ...
 */
@Service
public class BaiduDeviceControlHandler extends AbstractStrategyBaiduHandler<DeviceControlResponse, DeviceControlRequest> {
    ...
    protected BaiduDeviceControlHandler(CloudProtocolHandlerFactory factory, DeviceRelationManager deviceManager, BaiduActionConvert baiduActionConvert, DeviceServiceHttpManager deviceServiceHttpManager, BaiduStatusConverter baiduStatusConverter) {
