 ...
 */
@Service
public class BaiduDeviceQueryHandler extends AbstractStrategyBaiduHandler<JSONObject, DeviceQueryRequest> {
    ...
    protected BaiduDeviceQueryHandler(CloudProtocolHandlerFactory factory, DeviceRelationManager deviceManager, CustomMappingRepository customMappingRepository, DeviceServiceHttpManager deviceServiceHttpManager, CustomConvert customConvert, BaiduStatusConverter baiduStatusConverter) {
    ...
    protected JSONObject action1(DeviceQueryRequest deviceQueryRequest, ActionContext context) {
        ...
        DeviceInfo deviceInfo = deviceServiceHttpManager.getDeviceStatusByDeviceId(context, applianceId);
