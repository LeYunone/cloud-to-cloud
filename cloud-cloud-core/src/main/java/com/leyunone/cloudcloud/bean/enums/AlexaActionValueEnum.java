...
public enum AlexaActionValueEnum {
    ...
    SET_BRIGHTNESS("SetBrightness") {
        @Override
        public String valueConvert(AlexaControlRequest.Payload payload, AlexaProductMapping.CapabilityMapping capability) {
    ...
    protected String valueOfConvert(Object value, AlexaProductMapping.CapabilityMapping capability) {
    ...
    protected String noValueConvert(AlexaProductMapping.CapabilityMapping capability) {
        Map<String, Object> valueMapping = capability.getValueMapping();
        String value = "";
