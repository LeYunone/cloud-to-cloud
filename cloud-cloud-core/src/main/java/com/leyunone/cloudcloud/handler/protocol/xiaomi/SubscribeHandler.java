 ...
 **/
@Service
public class SubscribeHandler extends AbstractStrategyXiaomiHandler<SubscribeDevice, SubscribeDevice> {

    private final DeviceRelationManager deviceRelationManager;

    protected SubscribeHandler(CloudProtocolHandlerFactory factory, DeviceRelationManager deviceManager, DeviceRelationManager deviceRelationManager) {
    ...
    protected SubscribeDevice action1(SubscribeDevice subscribeDevice, ActionContext context) {
        ...
        List<DeviceCloudInfo> deviceEntities = subscribeDevice
                ...
                .map(d -> {
                    String did = d.getDid();
                    String subscriptionId = d.getSubscriptionId();
                    DeviceCloudInfo.ThirdMapping thirdMapping = DeviceCloudInfo
                            .ThirdMapping
                            .builder()
                            .thirdId(subscriptionId)
    ...
    protected String getKey() {
        return XiaomiIntent.SUBSCRIBE.name();
    }
}
