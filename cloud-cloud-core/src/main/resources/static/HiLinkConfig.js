Vue.component("huawei-config", {
    template: `
    <div>
        <div>
            <div style="text-align: center; font-weight: bold; position: relative; top: -5px;">< 华为HiLink配置页面 ></div>
            <el-row >
              <el-col >
            ...
            <el-tabs v-model="panelActiveName" type="border-card" @tab-click="paneHandler">
                ...
                <el-form :inline="true"  class="demo-form-inline">
                  ...
                  <el-form-item>
                    <el-button type="primary" @click="huaweiProductType">查询</el-button>
